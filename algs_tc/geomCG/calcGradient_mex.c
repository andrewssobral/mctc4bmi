 ...
 * a Tucker tensor X.
 * THIS ROUTINE IS ONLY CALLED THROUGH CALCGRADIENT.M!
...
void calcGradient( double* result, double* index, double* A, 
                  ...
                  int nrhs, const mxArray *prhs[])
{
    ...
    calcGradient( result, index, A, G, U1, U2, U3, k1, k2, k3, nnz );
}
